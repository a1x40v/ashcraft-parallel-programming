...
using ProducerConsumerRssFeeds.Services;
...
public class FeedAggregator
{
    ...
    public async Task<IEnumerable<BlogPost>> GetAllMicrosoftBlogPosts()
    {
        ...
        BufferBlock<SyndicationItem> itemQueue = new(new DataflowBlockOptions
        {
            BoundedCapacity = 10
        });
        ...
        await Task.WhenAll(producers, consumerA.Completion, consumerB.Completion, consumerC.Completion);
